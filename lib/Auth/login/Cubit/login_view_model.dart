import 'package:chat_app/Auth/login/Cubit/state.dart';
import 'package:chat_app/Firebase/fire_base_utils.dart';
  ...
  Future<void> login() async {
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        // نجيب بيانات اليوزر من Firestore بعد تسجيل الدخول
        MyUser? myUser =
